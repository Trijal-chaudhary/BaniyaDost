...
const { postShopSignupRouter, postLoginShopRouter, postisLoggedRouter, postWholeSalersDetailsRouter, postWholeDetailsByIdRouter, postProductOrderRouter } = require('./Router/ShopeRouter');
